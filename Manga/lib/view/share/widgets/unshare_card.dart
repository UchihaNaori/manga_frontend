...
class UnShareCard extends StatelessWidget {
  final User user;
  ShareController shareC = Get.find();
  UnShareCard({required this.user});
  @override
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed:  () {
              shareC.unShare(user.id);
            },
            icon:Image.asset('assets/images/icon_unshare.png', height: 30, fit: BoxFit.fitHeight,)
          )
        ],
      ),
    );
